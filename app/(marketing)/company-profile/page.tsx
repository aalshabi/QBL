...
import { companyProfileSchema } from "@/lib/structured-data";

export const metadata: Metadata = pageMetadata({
  title: "ملف تعريفي: مزوّد توصيل مبرّد آخر ميل في الرياض",
  description:
    "الملف التعريفي لشركة قدام بابك: التوصيل المبرّد آخر ميل في الرياض، الخدمات، العنوان، السجل التجاري 1010985560. اطبع الملف وشاركه مع فريق المشتريات.",
...
export default function CompanyProfilePage() {
  return (
      <>
        <JsonLd data={companyProfileSchema} />
