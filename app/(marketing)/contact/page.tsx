...
import { contactSchema } from "@/lib/structured-data";

export const metadata: Metadata = pageMetadata({
  title: "التواصل مع QBL: توصيل مبرّد آخر ميل في الرياض",
  description:
    "صفحة التواصل مع QBL لتوصيل مبرّد آخر ميل داخل الرياض: العنوان والبريد الرسمي للمبيعات والتشغيل والفواتير. راسلنا لمناقشة احتياج شركتك التشغيلي.",
  path: "/contact",
});
