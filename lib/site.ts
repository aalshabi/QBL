...
export const SERVICES: ServiceItem[] = [
  ...
  {
    icon: Pill,
    title: "المنتجات الحساسة للحرارة",
    desc: "تسليم منظم للمنتجات التي تتأثر بحرارة النقل، بإجراءات مناولة وتوثيق، دون ادعاء شهادات غير موثقة.",
  },
  {
    icon: Warehouse,
...
export const SECTORS = [
  ...
  { icon: Sparkles, title: "التجميل والعناية بالبشرة والشعر", desc: "توصيل محمي حرارياً للمكياج ومنتجات Skincare و Haircare من المصنّع أو المستودع حتى العميل النهائي." },
  { icon: Droplets, title: "العطور", desc: "نقل مناسب للعطور ومجموعات الهدايا العطرية التي تتأثر بحرارة النقل." },
  { icon: ShoppingBag, title: "متاجر Beauty الإلكترونية", desc: "دعم متاجر سلّة وزد و Shopify التي تبيع منتجات تجميل وعناية وعطور مباشرة للمستهلك." },
];
